    ...
    switch ($reply['reply_type']) {
        ...
        case 'validate_code':
            ...
            <div class="form-group">
                <label for="form-field-1" style="width: 85px; margin-top:5px; margin-bottom: 15px; float: left;" class="col-sm-3 control-label no-padding-right"><?php echo UserModule::t("Code Nr.") . ' ' . $reply['add_data']; ?></label>
