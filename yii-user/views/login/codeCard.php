                                                ...
                                                if (!empty($reply['reply_type']) && $reply['reply_type'] == 'validate_code') {
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9" style="float:left; margin-right: 5px;">
                                                            <input type="text" class="col-xs-10 col-sm-5 input-mini" style="height: 20px; line-height: 20px;" placeholder="<?php echo UserModule::t("Code"); ?>" autocomplete="off" id="code" name="code"/>
                                                        </div>
                                                        <?php  
